...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("unxlovwv")

  // remove
  collection.schema.removeField("jvdtvs8f")

  // remove
  collection.schema.removeField("6eriy7e3")

  // remove
  collection.schema.removeField("fvp8w5yp")

  // remove
  collection.schema.removeField("lnggsoew")

  // remove
  collection.schema.removeField("osvbskaq")

  // remove
  collection.schema.removeField("z9iuxfye")

  // remove
  collection.schema.removeField("8aloidoj")

  // remove
  collection.schema.removeField("vufijrfu")

  // remove
  collection.schema.removeField("rndplbdx")

  // remove
  collection.schema.removeField("1ory3llw")

  // remove
  collection.schema.removeField("rae9mg6t")

  // remove
  collection.schema.removeField("99f5weat")

  // remove
  collection.schema.removeField("1ka26hob")

  // remove
  collection.schema.removeField("bb8pzhcn")
