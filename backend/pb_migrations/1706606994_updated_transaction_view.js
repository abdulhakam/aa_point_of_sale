...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("c3w9ymty")

  // remove
  collection.schema.removeField("ak9az2rp")

  // remove
  collection.schema.removeField("zted6rog")

  // remove
  collection.schema.removeField("qqytwewr")

  // remove
  collection.schema.removeField("jjqgyoca")

  // remove
  collection.schema.removeField("fnoy7htl")

  // remove
  collection.schema.removeField("cennhwhb")

  // remove
  collection.schema.removeField("fgxhacpe")

  // remove
  collection.schema.removeField("jtyzhv95")

  // remove
  collection.schema.removeField("bgzze4fq")

  // remove
  collection.schema.removeField("jsoizizv")

  // remove
  collection.schema.removeField("wewfjnhj")
