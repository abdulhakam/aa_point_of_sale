...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("tpx32cbp")

  // remove
  collection.schema.removeField("9z3tgqzm")

  // remove
  collection.schema.removeField("jl7acxw5")

  // remove
  collection.schema.removeField("d2nt7ia1")

  // remove
  collection.schema.removeField("koltvjz5")

  // remove
  collection.schema.removeField("akbgze70")

  // remove
  collection.schema.removeField("9jbiqlby")

  // remove
  collection.schema.removeField("zz5pvqsx")

  // remove
  collection.schema.removeField("d5iydkao")

  // remove
  collection.schema.removeField("1mwyrcvc")

  // remove
  collection.schema.removeField("bq2jbchq")
