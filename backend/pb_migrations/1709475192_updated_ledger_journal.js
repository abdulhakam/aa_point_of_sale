...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("row7frtx")

  // remove
  collection.schema.removeField("phe93ctn")

  // remove
  collection.schema.removeField("nxiba7iu")

  // remove
  collection.schema.removeField("jsrs3n6g")

  // remove
  collection.schema.removeField("lanygjhf")

  // remove
  collection.schema.removeField("oga5wc4r")

  // remove
  collection.schema.removeField("dcnetjjv")

  // remove
  collection.schema.removeField("txbvatjl")

  // remove
  collection.schema.removeField("7azzjrku")
