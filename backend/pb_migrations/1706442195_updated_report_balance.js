...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("yako15mj")

  // remove
  collection.schema.removeField("exnxswjn")

  // remove
  collection.schema.removeField("hffptc2c")

  // remove
  collection.schema.removeField("rgfq349p")

  // remove
  collection.schema.removeField("bfj4tr2r")

  // remove
  collection.schema.removeField("xwjakz5h")

  // remove
  collection.schema.removeField("odn2ahsi")
