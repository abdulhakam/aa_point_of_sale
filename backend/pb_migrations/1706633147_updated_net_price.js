...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ugnaso44")

  // remove
  collection.schema.removeField("xnpvum2b")

  // remove
  collection.schema.removeField("notgfb6x")

  // remove
  collection.schema.removeField("gdckpr1t")

  // remove
  collection.schema.removeField("lkecnkln")

  // remove
  collection.schema.removeField("xbqpk4fb")
