...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("wgel1pcl")

  // remove
  collection.schema.removeField("mvypbiui")

  // remove
  collection.schema.removeField("upipvc5m")

  // remove
  collection.schema.removeField("dvy5x0d4")

  // remove
  collection.schema.removeField("g7bfrjif")

  // remove
  collection.schema.removeField("splbjbaf")

  // remove
  collection.schema.removeField("gceb3sfd")

  // remove
  collection.schema.removeField("6zoa3weu")

  // remove
  collection.schema.removeField("bzazmzuu")

  // remove
  collection.schema.removeField("rey9p9d0")

  // remove
  collection.schema.removeField("xm4ib4ll")

  // remove
  collection.schema.removeField("nzmktnmj")
