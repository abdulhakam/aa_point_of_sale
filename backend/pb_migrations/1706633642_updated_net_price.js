...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("tvzfkfoe")

  // remove
  collection.schema.removeField("xcqjgcva")

  // remove
  collection.schema.removeField("xesa6njq")

  // remove
  collection.schema.removeField("e91prdei")

  // remove
  collection.schema.removeField("52zo31ee")

  // remove
  collection.schema.removeField("ccmawvil")
  ...
  // remove
  collection.schema.removeField("oeb2gezc")

  // remove
  collection.schema.removeField("wgqy4cjx")

  // remove
  collection.schema.removeField("putkgip5")

  // remove
  collection.schema.removeField("oqtlfcp1")

  // remove
  collection.schema.removeField("cqjzhkud")

  // remove
  collection.schema.removeField("avvk3ut4")
