...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("5yqmgwym")

  // remove
  collection.schema.removeField("9mpndd1w")

  // remove
  collection.schema.removeField("kyqdc33z")

  // remove
  collection.schema.removeField("6s4izuam")

  // remove
  collection.schema.removeField("frce9n9k")

  // remove
  collection.schema.removeField("3wtyfvmy")

  // remove
  collection.schema.removeField("t6lgtv5r")

  // remove
  collection.schema.removeField("sovb6btl")

  // remove
  collection.schema.removeField("nolwxued")

  // remove
  collection.schema.removeField("jpf35jbi")

  // remove
  collection.schema.removeField("27mulwtz")

  // remove
  collection.schema.removeField("ef654fip")

  // remove
  collection.schema.removeField("rcql1rtw")

  // remove
  collection.schema.removeField("4si4yuan")
