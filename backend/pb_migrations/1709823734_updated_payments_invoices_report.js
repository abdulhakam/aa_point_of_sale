...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ieuwteen")

  // remove
  collection.schema.removeField("v8kxvjgn")

  // remove
  collection.schema.removeField("tyzyjr8r")

  // remove
  collection.schema.removeField("lnnouix5")

  // remove
  collection.schema.removeField("xgks0ghp")

  // remove
  collection.schema.removeField("vb92y5gz")

  // remove
  collection.schema.removeField("8nq17yoh")

  // remove
  collection.schema.removeField("xmlpo0qe")

  // remove
  collection.schema.removeField("pcxdnt32")

  // remove
  collection.schema.removeField("md7zyusp")

  // remove
  collection.schema.removeField("oi3huit3")

  // remove
  collection.schema.removeField("zhvbulfu")

  // remove
  collection.schema.removeField("g0hfslnb")

  // remove
  collection.schema.removeField("mlhyisef")

  // remove
  collection.schema.removeField("isaqk9rj")
