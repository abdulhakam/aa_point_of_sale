...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("yatsproj")

  // remove
  collection.schema.removeField("x1pgx6ch")

  // remove
  collection.schema.removeField("xruzphgn")

  // remove
  collection.schema.removeField("lfqomswn")

  // remove
  collection.schema.removeField("htpogrbq")

  // remove
  collection.schema.removeField("4guwp6hj")

  // remove
  collection.schema.removeField("o6qdgcqa")

  // remove
  collection.schema.removeField("n7fh5bf5")

  // remove
  collection.schema.removeField("amcaprnk")

  // remove
  collection.schema.removeField("lawjm4id")

  // remove
  collection.schema.removeField("fctgvsvt")

  // remove
  collection.schema.removeField("n3uuhxer")
