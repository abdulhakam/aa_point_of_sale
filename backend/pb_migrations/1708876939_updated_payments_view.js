...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("xgpq14dz")

  // remove
  collection.schema.removeField("umisb994")

  // remove
  collection.schema.removeField("nmd5kotz")

  // remove
  collection.schema.removeField("hamuioek")

  // remove
  collection.schema.removeField("nw9dout5")

  // remove
  collection.schema.removeField("74ptkjdo")

  // remove
  collection.schema.removeField("aqm2cvzc")

  // remove
  collection.schema.removeField("cakswqyx")

  // remove
  collection.schema.removeField("z2tcgryt")

  // remove
  collection.schema.removeField("rhrrwa8r")

  // remove
  collection.schema.removeField("zijztf75")

  // remove
  collection.schema.removeField("lhksrcsb")

  // remove
  collection.schema.removeField("bcdn2tqy")

  // remove
  collection.schema.removeField("fowsoime")

  // remove
  collection.schema.removeField("p1vpddj7")
