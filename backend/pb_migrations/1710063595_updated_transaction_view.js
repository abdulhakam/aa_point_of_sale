...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("8em24819")

  // remove
  collection.schema.removeField("ondh9cyg")

  // remove
  collection.schema.removeField("b5cntbyw")

  // remove
  collection.schema.removeField("wnz7fuir")

  // remove
  collection.schema.removeField("b9zvukdx")

  // remove
  collection.schema.removeField("25sb9lgs")

  // remove
  collection.schema.removeField("qvr3c0ie")

  // remove
  collection.schema.removeField("vusqx7kx")

  // remove
  collection.schema.removeField("5aqxzlkf")

  // remove
  collection.schema.removeField("n5bxrkh1")

  // remove
  collection.schema.removeField("jrbh3fwy")

  // remove
  collection.schema.removeField("cbr1qtym")

  // remove
  collection.schema.removeField("us4rdvfl")

  // remove
  collection.schema.removeField("3mbr7slc")

  // remove
  collection.schema.removeField("cpexmkqs")

  // remove
  collection.schema.removeField("8toji3wj")

  // remove
  collection.schema.removeField("tw551gkk")

  // remove
  collection.schema.removeField("vvfnxyhv")

  // remove
  collection.schema.removeField("h0ofs49i")

  // remove
  collection.schema.removeField("9oarxoah")

  // remove
  collection.schema.removeField("4qszig1h")

  // remove
  collection.schema.removeField("f4qnm8uu")
