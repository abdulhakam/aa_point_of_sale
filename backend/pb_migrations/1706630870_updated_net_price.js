...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("kxjv8uer")

  // remove
  collection.schema.removeField("akamiaah")

  // remove
  collection.schema.removeField("2a2xxeyx")

  // remove
  collection.schema.removeField("qrglwiax")

  // remove
  collection.schema.removeField("ftpym36e")

  // remove
  collection.schema.removeField("lf8zynhl")
