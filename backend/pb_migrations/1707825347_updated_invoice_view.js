...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("au2eyieg")

  // remove
  collection.schema.removeField("gnj68hcs")

  // remove
  collection.schema.removeField("mbqcotml")

  // remove
  collection.schema.removeField("oy124h1i")

  // remove
  collection.schema.removeField("dtiouzqr")

  // remove
  collection.schema.removeField("e543ooxy")

  // remove
  collection.schema.removeField("fnxrkfoc")

  // remove
  collection.schema.removeField("xg0kty42")

  // remove
  collection.schema.removeField("qojymore")

  // remove
  collection.schema.removeField("gqhtpl1o")

  // remove
  collection.schema.removeField("ejl11gs9")

  // remove
  collection.schema.removeField("zemu04xx")

  // remove
  collection.schema.removeField("zcugua6f")

  // remove
  collection.schema.removeField("9x3hmvsw")
