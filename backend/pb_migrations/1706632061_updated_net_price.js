...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ww3gfwm8")

  // remove
  collection.schema.removeField("e36lbzdu")

  // remove
  collection.schema.removeField("imh005c4")

  // remove
  collection.schema.removeField("wbo5tt8n")

  // remove
  collection.schema.removeField("pdpvubnt")

  // remove
  collection.schema.removeField("xru3agad")

  // remove
  collection.schema.removeField("pr9fdawu")
