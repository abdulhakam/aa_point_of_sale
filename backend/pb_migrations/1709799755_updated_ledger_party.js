...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("g6crcyfw")

  // remove
  collection.schema.removeField("01zuh8jt")

  // remove
  collection.schema.removeField("kssyo9vs")

  // remove
  collection.schema.removeField("wvk6rxsv")

  // remove
  collection.schema.removeField("2gm0gwye")

  // remove
  collection.schema.removeField("d1onpqxu")

  // remove
  collection.schema.removeField("jqqwhz3s")
