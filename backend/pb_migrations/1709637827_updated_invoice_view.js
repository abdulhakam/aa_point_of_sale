...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("fr9i1pej")

  // remove
  collection.schema.removeField("xuzi2yjt")

  // remove
  collection.schema.removeField("jvaj2ehn")

  // remove
  collection.schema.removeField("p6gkl3fd")

  // remove
  collection.schema.removeField("uxztsr9e")

  // remove
  collection.schema.removeField("4oi8quqw")

  // remove
  collection.schema.removeField("7s6huf0a")

  // remove
  collection.schema.removeField("ri6ieiai")

  // remove
  collection.schema.removeField("1ylw2z6i")

  // remove
  collection.schema.removeField("yi0b1t4e")

  // remove
  collection.schema.removeField("ybomrkb8")

  // remove
  collection.schema.removeField("tefqbywh")

  // remove
  collection.schema.removeField("uutgarfx")

  // remove
  collection.schema.removeField("ezjrog4a")

  // remove
  collection.schema.removeField("key8p2pn")
