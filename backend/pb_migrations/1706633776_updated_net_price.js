...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("6fyhywjb")

  // remove
  collection.schema.removeField("vvigo5pl")

  // remove
  collection.schema.removeField("l6sz1lwb")

  // remove
  collection.schema.removeField("a5h7imoc")

  // remove
  collection.schema.removeField("uiudy5cb")

  // remove
  collection.schema.removeField("yhmxv2fx")
