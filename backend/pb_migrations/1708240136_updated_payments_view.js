...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("kbhrcfw9")

  // remove
  collection.schema.removeField("r3ph9pfy")

  // remove
  collection.schema.removeField("gnwwffub")

  // remove
  collection.schema.removeField("bodwxrmm")

  // remove
  collection.schema.removeField("vbyb3yda")

  // remove
  collection.schema.removeField("r7b0gwox")

  // remove
  collection.schema.removeField("bhu6qp02")

  // remove
  collection.schema.removeField("xhetsoc3")

  // remove
  collection.schema.removeField("nklxlj6s")

  // remove
  collection.schema.removeField("64y0f72w")

  // remove
  collection.schema.removeField("hcqnew3p")

  // remove
  collection.schema.removeField("8ucyisbo")

  // remove
  collection.schema.removeField("rszvnokh")

  // remove
  collection.schema.removeField("xzazhjfc")
