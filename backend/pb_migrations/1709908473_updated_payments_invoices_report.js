...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("22hkbpfr")

  // remove
  collection.schema.removeField("e7rubv4o")

  // remove
  collection.schema.removeField("tzttxyq5")

  // remove
  collection.schema.removeField("xsunmxjc")

  // remove
  collection.schema.removeField("3gw87bwd")

  // remove
  collection.schema.removeField("toqws0rj")

  // remove
  collection.schema.removeField("pnm4reee")

  // remove
  collection.schema.removeField("dbpimqfk")

  // remove
  collection.schema.removeField("cr6bw5wp")

  // remove
  collection.schema.removeField("ujhk6zqv")

  // remove
  collection.schema.removeField("qyduyf3a")

  // remove
  collection.schema.removeField("nmogrimb")

  // remove
  collection.schema.removeField("og4yjhys")

  // remove
  collection.schema.removeField("jgarqt5t")
