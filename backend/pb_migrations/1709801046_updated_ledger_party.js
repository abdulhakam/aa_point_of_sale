...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("9gep7rra")

  // remove
  collection.schema.removeField("w7qhnhft")

  // remove
  collection.schema.removeField("qnwknpal")

  // remove
  collection.schema.removeField("4glerrbf")

  // remove
  collection.schema.removeField("3j06wxkp")

  // remove
  collection.schema.removeField("enklv6lk")

  // remove
  collection.schema.removeField("rhwyiecx")

  // remove
  collection.schema.removeField("jlut1xfd")
