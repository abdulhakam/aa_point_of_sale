...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("2lwu1ppw")

  // remove
  collection.schema.removeField("6djkpkyq")

  // remove
  collection.schema.removeField("qfghobqv")

  // remove
  collection.schema.removeField("a2or6mdf")

  // remove
  collection.schema.removeField("zubezyxp")

  // remove
  collection.schema.removeField("jp0zo6zl")
  ...
  // remove
  collection.schema.removeField("dwehqgpn")

  // remove
  collection.schema.removeField("hwzetuk6")

  // remove
  collection.schema.removeField("479npep2")

  // remove
  collection.schema.removeField("ccwf8p4c")

  // remove
  collection.schema.removeField("qvkf6s06")

  // remove
  collection.schema.removeField("jrtroiu1")
