...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("l686zptj")

  // remove
  collection.schema.removeField("dfaiwohj")

  // remove
  collection.schema.removeField("xyrpr6p7")

  // remove
  collection.schema.removeField("xicp5mjl")

  // remove
  collection.schema.removeField("sevunoof")

  // remove
  collection.schema.removeField("hx87xy1a")

  // remove
  collection.schema.removeField("tiqolf5g")

  // remove
  collection.schema.removeField("cyw13d3q")
