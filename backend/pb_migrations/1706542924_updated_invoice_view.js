...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("knfi4lbg")

  // remove
  collection.schema.removeField("wbnsf4bs")

  // remove
  collection.schema.removeField("tn8jq8tt")

  // remove
  collection.schema.removeField("s0mupmbu")

  // remove
  collection.schema.removeField("5cll4mq4")

  // remove
  collection.schema.removeField("zk3hullx")

  // remove
  collection.schema.removeField("hmihu9q8")

  // remove
  collection.schema.removeField("yl8spted")

  // remove
  collection.schema.removeField("pdkpx2rk")

  // remove
  collection.schema.removeField("9khavgl1")

  // remove
  collection.schema.removeField("etltwgzz")

  // remove
  collection.schema.removeField("qk90bfqn")

  // remove
  collection.schema.removeField("jpn0msbf")
