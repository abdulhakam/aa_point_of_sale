...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("cgjm7d0r")

  // remove
  collection.schema.removeField("ajzgabkz")

  // remove
  collection.schema.removeField("vha12kfl")

  // remove
  collection.schema.removeField("idzskzdf")

  // remove
  collection.schema.removeField("pw0lvgac")

  // remove
  collection.schema.removeField("mnsiyqtg")
