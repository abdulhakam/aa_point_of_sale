...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("vz8y4spc")

  // remove
  collection.schema.removeField("i3eg5d5b")

  // remove
  collection.schema.removeField("u6z4yauy")

  // remove
  collection.schema.removeField("hihvwshb")

  // remove
  collection.schema.removeField("aiwljpuy")

  // remove
  collection.schema.removeField("n7ewqgxo")

  // remove
  collection.schema.removeField("iuciyk6a")

  // remove
  collection.schema.removeField("7letbjuu")

  // remove
  collection.schema.removeField("ivdfihyw")
  ...
  collection.options = {
    "query": "SELECT id,\n  invoice,\n  item,\n  price,\n  qty,\n  scheme,\n  discount_1,\n  discount_2,\n  z_trans_d1_t.d1t*discount_2/100 AS total,\n  deleted,\n  created,\n  updated from z_trans_d1_t"
  }
