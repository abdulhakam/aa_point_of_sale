...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("qnbhbhvi")

  // remove
  collection.schema.removeField("wpgs8qyk")

  // remove
  collection.schema.removeField("eg2fmrzf")

  // remove
  collection.schema.removeField("83hsbjyt")

  // remove
  collection.schema.removeField("huxdas8y")

  // remove
  collection.schema.removeField("rh3fcthw")
