...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("jxzdhjgx")

  // remove
  collection.schema.removeField("lz29tbsw")

  // remove
  collection.schema.removeField("bcch2azy")

  // remove
  collection.schema.removeField("qbksdsjl")

  // remove
  collection.schema.removeField("l36bwrxb")

  // remove
  collection.schema.removeField("wzrcdufj")
  ...
  // remove
  collection.schema.removeField("usxlfdio")

  // remove
  collection.schema.removeField("rsjwvmg8")

  // remove
  collection.schema.removeField("j3pmfnth")

  // remove
  collection.schema.removeField("nym8slxi")

  // remove
  collection.schema.removeField("lrmia7bo")

  // remove
  collection.schema.removeField("ydhvgz1d")
