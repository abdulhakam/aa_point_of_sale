...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("kla5pmqj")

  // remove
  collection.schema.removeField("fx6snopl")

  // remove
  collection.schema.removeField("zxx7civb")

  // remove
  collection.schema.removeField("lygjejxx")

  // remove
  collection.schema.removeField("veh7wvme")

  // remove
  collection.schema.removeField("9tars0hz")

  // remove
  collection.schema.removeField("df4nmlly")

  // remove
  collection.schema.removeField("dlq3xk4l")

  // remove
  collection.schema.removeField("azs20nu4")

  // remove
  collection.schema.removeField("laprq742")

  // remove
  collection.schema.removeField("yjfxezas")

  // remove
  collection.schema.removeField("reicpqji")

  // remove
  collection.schema.removeField("yr0mcnm2")

  // remove
  collection.schema.removeField("fbznkt25")

  // remove
  collection.schema.removeField("wpzofoin")

  // remove
  collection.schema.removeField("fggdvd3y")

  // remove
  collection.schema.removeField("rqlxwc93")

  // remove
  collection.schema.removeField("bdjvthuv")

  // remove
  collection.schema.removeField("qmzo5hrb")

  // remove
  collection.schema.removeField("enyfjmug")
