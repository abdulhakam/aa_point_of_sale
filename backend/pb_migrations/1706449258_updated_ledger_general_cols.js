...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("vrq7xccy")

  // remove
  collection.schema.removeField("izdkxjo0")

  // remove
  collection.schema.removeField("z6faynmu")

  // remove
  collection.schema.removeField("wqrrfavg")

  // remove
  collection.schema.removeField("4bjlvo5y")

  // remove
  collection.schema.removeField("xiiji1rr")

  // remove
  collection.schema.removeField("hcj9ozyh")

  // remove
  collection.schema.removeField("osqcuniy")

  // remove
  collection.schema.removeField("jsaffnuj")
