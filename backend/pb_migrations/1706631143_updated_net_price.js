...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("a3oaaxks")

  // remove
  collection.schema.removeField("itegzcr9")

  // remove
  collection.schema.removeField("k6njresf")

  // remove
  collection.schema.removeField("4f4uhfdz")

  // remove
  collection.schema.removeField("d6j4sg3h")

  // remove
  collection.schema.removeField("mtwzlptu")
