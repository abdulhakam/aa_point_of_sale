...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("osnz6tow")

  // remove
  collection.schema.removeField("qkqssmnd")

  // remove
  collection.schema.removeField("qrjrbdyy")

  // remove
  collection.schema.removeField("tp3q6mz5")

  // remove
  collection.schema.removeField("m8tv1viu")

  // remove
  collection.schema.removeField("na8qn7h6")

  // remove
  collection.schema.removeField("axnrsojl")

  // remove
  collection.schema.removeField("7yecg7hy")

  // remove
  collection.schema.removeField("vourgump")

  // remove
  collection.schema.removeField("gjbdgary")

  // remove
  collection.schema.removeField("amja69bi")

  // remove
  collection.schema.removeField("qjiqwxia")

  // remove
  collection.schema.removeField("wnxttdaa")

  // remove
  collection.schema.removeField("dbrqz32r")

  // remove
  collection.schema.removeField("oyqmqeuq")
