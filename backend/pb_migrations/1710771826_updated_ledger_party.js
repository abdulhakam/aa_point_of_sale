...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("lbaiu9nq")

  // remove
  collection.schema.removeField("cplkmp3c")

  // remove
  collection.schema.removeField("tle1ec2k")

  // remove
  collection.schema.removeField("q5ljwqnh")

  // remove
  collection.schema.removeField("3rpmd84u")

  // remove
  collection.schema.removeField("oiii80rl")

  // remove
  collection.schema.removeField("rvu4zf6j")

  // remove
  collection.schema.removeField("zblimt5s")

  // remove
  collection.schema.removeField("lxhvkimq")
