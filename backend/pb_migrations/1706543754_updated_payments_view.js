...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ygbata4a")

  // remove
  collection.schema.removeField("r90b7kma")

  // remove
  collection.schema.removeField("pvwa1sf2")

  // remove
  collection.schema.removeField("6wruevrp")

  // remove
  collection.schema.removeField("ajaun6ba")

  // remove
  collection.schema.removeField("gcefeqrb")

  // remove
  collection.schema.removeField("0l6mtv2h")

  // remove
  collection.schema.removeField("jzqzbqgm")

  // remove
  collection.schema.removeField("pvwwr0lc")
