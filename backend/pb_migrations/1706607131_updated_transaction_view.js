...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("vvgokmbq")

  // remove
  collection.schema.removeField("emzf2uqy")

  // remove
  collection.schema.removeField("rwdrzouh")

  // remove
  collection.schema.removeField("cdeciitt")

  // remove
  collection.schema.removeField("0app9xim")

  // remove
  collection.schema.removeField("naymiluw")

  // remove
  collection.schema.removeField("lquebxfz")

  // remove
  collection.schema.removeField("rbgi73gn")

  // remove
  collection.schema.removeField("kmralpxq")

  // remove
  collection.schema.removeField("5nqpkwt3")

  // remove
  collection.schema.removeField("cfnhzpan")

  // remove
  collection.schema.removeField("9ufgpjgu")
