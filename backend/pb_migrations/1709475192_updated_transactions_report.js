...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("adjnm5ec")

  // remove
  collection.schema.removeField("el1911f5")

  // remove
  collection.schema.removeField("e0wm04bb")

  // remove
  collection.schema.removeField("gs9zbyzb")

  // remove
  collection.schema.removeField("q9o9mfol")

  // remove
  collection.schema.removeField("fxdjo2q6")

  // remove
  collection.schema.removeField("pvww4kot")

  // remove
  collection.schema.removeField("pzuwxe5y")

  // remove
  collection.schema.removeField("lhcorvmb")

  // remove
  collection.schema.removeField("nk0cjm5i")

  // remove
  collection.schema.removeField("0x9k0dbk")

  // remove
  collection.schema.removeField("qpmt9ngn")

  // remove
  collection.schema.removeField("2rg4ehdi")

  // remove
  collection.schema.removeField("hhzcqxyj")

  // remove
  collection.schema.removeField("qkh6rili")

  // remove
  collection.schema.removeField("4alen6ed")

  // remove
  collection.schema.removeField("l6m8zwzo")

  // remove
  collection.schema.removeField("ikst2qrp")

  // remove
  collection.schema.removeField("psob2yds")

  // remove
  collection.schema.removeField("hnxi8x05")
