...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("kanavn40")

  // remove
  collection.schema.removeField("mmw5mpki")

  // remove
  collection.schema.removeField("cvswutxb")

  // remove
  collection.schema.removeField("zzsjtzr5")

  // remove
  collection.schema.removeField("hsnsgmon")
