...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("3kgqc0d0")

  // remove
  collection.schema.removeField("azi7kfkh")

  // remove
  collection.schema.removeField("ca5gx608")

  // remove
  collection.schema.removeField("lxd4l4oi")

  // remove
  collection.schema.removeField("ikcl61d9")

  // remove
  collection.schema.removeField("szgsrgi7")

  // remove
  collection.schema.removeField("6rra1cg8")

  // remove
  collection.schema.removeField("atevzk29")

  // remove
  collection.schema.removeField("g3xdluds")

  // remove
  collection.schema.removeField("epaeyved")

  // remove
  collection.schema.removeField("qy3qoqne")

  // remove
  collection.schema.removeField("goichnfu")

  // remove
  collection.schema.removeField("fjwhnzh5")
