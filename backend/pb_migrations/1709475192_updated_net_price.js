...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("vcstro66")

  // remove
  collection.schema.removeField("anxrvah2")

  // remove
  collection.schema.removeField("tfe1s6m9")

  // remove
  collection.schema.removeField("njt6kwon")

  // remove
  collection.schema.removeField("wm7bgym4")

  // remove
  collection.schema.removeField("hhxlxupc")

  // remove
  collection.schema.removeField("xazeiwff")
