...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("g5e07j3z")

  // remove
  collection.schema.removeField("ibjk0m13")

  // remove
  collection.schema.removeField("ibjoqcxu")

  // remove
  collection.schema.removeField("93bpabw6")

  // remove
  collection.schema.removeField("tga5fbfm")

  // remove
  collection.schema.removeField("qeqispmm")

  // remove
  collection.schema.removeField("j9n339w2")

  // remove
  collection.schema.removeField("1oyyeuxq")

  // remove
  collection.schema.removeField("thwyr36a")

  // remove
  collection.schema.removeField("dcj9cgd0")

  // remove
  collection.schema.removeField("ugy0vlrs")

  // remove
  collection.schema.removeField("wa3lkjse")

  // remove
  collection.schema.removeField("6rocss2z")

  // remove
  collection.schema.removeField("q8m1nrnh")

  // remove
  collection.schema.removeField("a0vnen32")

  // remove
  collection.schema.removeField("nzowtg1m")

  // remove
  collection.schema.removeField("pdqs8m5y")

  // remove
  collection.schema.removeField("3izeigm6")

  // remove
  collection.schema.removeField("99vfor3k")

  // remove
  collection.schema.removeField("te3idbgd")

  // remove
  collection.schema.removeField("fl1ogsm2")

  // remove
  collection.schema.removeField("hdw8cazt")
